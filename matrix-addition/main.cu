...
int main (int argc, char *argv[])
{
    ...
    /*************************************************************************/
    //INSERT CODE HERE
    int size_of_obj = mat_sz * sizeof(float);
    cudaMalloc((void**)&A_d, size_of_obj);
    cudaMalloc((void**)&B_d, size_of_obj);
    cudaMalloc((void**)&C_d, size_of_obj);
    ...
    /*************************************************************************/
    //INSERT CODE HERE
    cudaMemcpy(A_d, A_h, size_of_obj, cudaMemcpyHostToDevice);
    cudaMemcpy(B_d, B_h, size_of_obj, cudaMemcpyHostToDevice);
    ...
    /*************************************************************************/
    //INSERT CODE HERE
    cudaMemcpy(C_h, C_d, size_of_obj, cudaMemcpyDeviceToHost);
